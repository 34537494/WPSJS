...
class WebAddinHeader extends React.Component {
  onLinkClick = (item) => {
    ...
    this.props.history.push({
      pathname: linkAdress[item.props.itemKey],
      state: {},
    });
  ...
  render() {
    ...
    const hostStyles = {
      root: { display: "inline-block", paddingRight: "10px" },
    };
            ...
            <div style={{ marginRight: "10px" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      onClick={this.handleAvatarClick.bind(this, this.props)}
                      src={
                        `${RootPath}`.slice(0, `${RootPath}`.length - 1) +
                        `${apiPublicPath}users/avatar?user_id=` +
...
export default connect(mapState, mapDispatch)(WebAddinHeader);
