...
import { Avatar, InputNumber, Input, Image, Button } from "antd";
import {
  UserOutlined,
  ArrowDownOutlined,
  DingdingOutlined,
    ...
    return (
      <div className="myStyle_1">
        ...
        <div className="inputTable">
          ...
          <Button size="middle" shape="round" onClick={this.imageClick.bind(this, "表格")}>
            <span>插入表格</span>
          </Button>
          <div>
            行数：
        ...
        <div className="inputWords">
          <h1>插入文字<Avatar
            ...
            icon={<UserOutlined />}
          /></h1>
          <Button size="middle" shape="round" onClick={this.textClick.bind(this, "文字")}>
            <span>插入文字</span>
          </Button>
          {/* <p>插入文字</p> */}
          <TextArea
